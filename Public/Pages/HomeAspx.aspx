<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.HomeAspx, App_Web_yx2u1ccd" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/HomeAspx_USER.js??sv=4.0_20250520224510") %>"></script>
									...
									<asp:Repeater id="Repeater1" runat="server" ClientIDMode="Static">
										...
										<AlternatingItemTemplate>
											<div id="GRepeaterBodyAlt1" runat="server" class="row c_GRepeaterBodyAlt1">
												...
												<div id="LayoutCol5" class="col  col-12col-sm-6 c_LayoutCol5">
													...
													<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton" CssClass="c_Button2 button-rounded-secondary"
														CommandName="Button2" HasDatalistParent="true" RenderMode="Lightweight" TabIndex="4" Text="<%$ Resources: Button2 %>">
													</telerik:RadButton>
												</div>
											</div>
										</AlternatingItemTemplate>
