<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" enableeventvalidation="True" validaterequest="false" inherits="PROJETO.LoginPage, App_Web_yx2u1ccd" culture="auto" uiculture="auto" %>
...
<head runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Bootstrap_Button_button_rounded_warning.css" OrderIndex="0"/>
	...
	<telerik:RadCodeBlock ID="HeaderCodeBlock" runat="server">
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/validationEngine.jquery.css??sv=4.0_20250520224510") %>" type="text/css" media="screen" title="no title"/>
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/animate.min.css??sv=4.0_20250520224510") %>" type="text/css" media="screen" title="no title"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/wow.min.js??sv=4.0_20250520224510") %>" ></script>
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Functions.js??sv=4.0_20250520224510") %>"></script>
			...
			<script type="text/javascript" src="<%= ResolveUrl("~/JS/LoginPage_USER.js??sv=4.0_20250520224510") %>"></script>
				...
				<telerik:RadAjaxPanel id="ajxMainAjaxPanel" runat="server" CssClass="c_ajxMainAjaxPanel" LoadingPanelID="___ajxMainAjaxPanel_AjaxLoading">
					...
					<div id="LayoutContainer1" runat="server" class="container c_LayoutContainer1">
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							<div id="LayoutCol9" class="col  col-12col-sm-10 offset-sm-1 c_LayoutCol9">
								<div id="LayoutRow6" class="row c_LayoutRow6 card flex-row">
									<div id="LayoutCol10" class="col  col-12col-sm-7 c_LayoutCol10">
									...
									<div id="LayoutCol11" class="col  col-12 c_LayoutCol11 card-body">
										...
										<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton"
											CssClass="c_Button1 button-rounded-warning gvButtonIconText gvButtonAlignIconLeft" CommandName="Button1" OnClick="___Button1_OnClick"
