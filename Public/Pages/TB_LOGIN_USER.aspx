<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.TB_LOGIN_USER, App_Web_yx2u1ccd" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_LOGIN_USER_USER.js??sv=4.0_20250520224510") %>"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol9" class="col col-12 col-sm-8 c_LayoutCol9">
							...
							<div id="LayoutCol10" class="col col-6 col-sm-4 c_LayoutCol10">
							...
							<div id="LayoutCol15" class="col col-12 col-sm-8 c_LayoutCol15">
							...
							<div id="LayoutCol11" class="col col-6 col-sm-4 c_LayoutCol11">
