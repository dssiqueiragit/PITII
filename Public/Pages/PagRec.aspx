<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.PagRec, App_Web_yx2u1ccd" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/PagRec_USER.js??sv=4.0_20250520224510") %>"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol6" class="col  col-12col-sm-5 c_LayoutCol6">
							...
							<div id="LayoutCol8" class="col  col-12col-sm-2 c_LayoutCol8">
							...
							<div id="LayoutCol7" class="col  col-12col-sm-5 c_LayoutCol7">
						...
						<div id="LayoutRow3" class="row c_LayoutRow3">
							<div id="LayoutCol9" class="col  col-12col-sm-6 c_LayoutCol9">
