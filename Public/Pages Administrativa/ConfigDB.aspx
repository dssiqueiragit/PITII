<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.ConfigDB, App_Web_uy5fufe5" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/jquery.js??sv=4.0_20250520224510") %>" ></script>
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/RadComboBoxHelper.js??sv=4.0_20250520224510") %>"></script>


	<script type="text/javascript" src="<%= ResolveUrl("~/JS/ConfigDB_USER.js??sv=4.0_20250520224510") %>"></script>
	</telerik:RadCodeBlock>
