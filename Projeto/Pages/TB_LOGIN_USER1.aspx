<%@ Page Language="C#" ValidateRequest="false" MaintainScrollPositionOnPostback="true" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_LOGIN_USER1.aspx.cs" Inherits="PROJETO.DataPages.TB_LOGIN_USER1" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_LOGIN_USER1.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_LOGIN_USER1_USER.js??sv=4.0_20250523015019") %>"></script>
					...
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Usuário de login" />
							</div>
						</div>
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol6" class="col col-9 c_LayoutCol6">
							...
							<div id="LayoutCol7" class="col col-3 c_LayoutCol7">
							...
							<div id="LayoutCol9" class="col col-6 c_LayoutCol9">
							...
							<div id="LayoutCol10" class="col col-8 c_LayoutCol10">
							...
							<div id="LayoutCol14" class="col col-8 c_LayoutCol14">
