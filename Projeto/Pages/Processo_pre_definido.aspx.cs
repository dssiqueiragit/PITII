...
namespace PROJETO.DataPages
{
	...
	public partial class Processo_pre_definido : GeneralDataProcess
	{

		private Processo_pre_definidoProcessProvider PageProvider;

		public override string FormID { get { return "36038"; } }
		public override string PageName { get { return "Processo_pre_definido.aspx"; } }

		public override void CreateProvider()
		{
			PageProvider = new Processo_pre_definidoProcessProvider(this);
		}
