...
<head id="Head1" runat="server">
	...
	<telerik:RadCodeBlock ID="HeaderCodeBlock" runat="server">
		...
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/bootstrap5.min.css??sv=4.0_20250520000307") %>" type="text/css" media="screen" title="no title"/>
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/all.min.css??sv=4.0_20250520000307") %>" type="text/css" media="screen" title="no title"/>  	
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/gvbaselayout.css??sv=4.0_20250520000307") %>" type="text/css" media="screen" title="no title"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/jquery.mask.min.js??sv=4.0_20250520000307") %>" ></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/jquery.mask.global.js??sv=4.0_20250520000307") %>" ></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/bootstrap5.bundle.min.js??sv=4.0_20250520000307") %>" ></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/wow.min.js") %>" ></script>
		<script type="text/javascript"> new WOW().init(); </script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Page.js??sv=4.0_20250520000307") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Common.js??sv=4.0_20250520000307") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Functions.js??sv=4.0_20250520000307") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/RadComboBoxHelper.js") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Pag_Cad_Venda_USER.js??sv=4.0_20250520000307") %>"></script>
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/jquery.mCustomScrollbar.concat.min.js??sv=4.0_20250520000307") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/LayoutController.js??sv=4.0_20250520000307") %>" ></script>
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol4" class="col  col-12col-sm-8 c_LayoutCol4">
								...
								<telerik:RadComboBox id="ComboBox_ID_CLIENTE" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox_ID_CLIENTE_OnItemsRequested" RenderMode="Lightweight" TabIndex="4" />
							</div>
						</div>
						<div id="LayoutRow3" class="row c_LayoutRow3">
							...
							<div id="LayoutCol5" class="col  col-12 c_LayoutCol5">
								...
								<telerik:RadTextBox id="RadTextBox_OBS_VENDA" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_OBS_VENDA textbox-default"
									...
									onkeydown="___RadTextBox_OBS_VENDA_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="2" TextMode="MultiLine"
								...
								<div id="LayoutRow5" class="row c_LayoutRow5">
									<div id="LayoutCol7" class="col  col-12col-sm-6 c_LayoutCol7">
										...
										<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
											...
											OnItemsRequested="___ComboBox1_OnItemsRequested" RenderMode="Lightweight" TabIndex="10" />
									</div>
								...
								<telerik:RadToolBar id="gToolbar" runat="server" CssClass="c_gToolbar" EnableRoundedCorners="True" EnableShadows="True"
									...
									<Items>
										<telerik:RadToolBarButton id="Button1" runat="server" ButtonType="SkinnedButton" CssClass="c_Button1 Button1" CommandArgument="Button1"
											CommandName="Button1" RenderMode="Lightweight" TabIndex="5" ToolTip="Cria novo registro">
										...
										<telerik:RadToolBarButton id="Button2" runat="server" ButtonType="SkinnedButton" CssClass="c_Button2 Button2" CommandArgument="Button2"
											CommandName="Button2" RenderMode="Lightweight" TabIndex="6" ToolTip="Grava alterações do registro atual">
										</telerik:RadToolBarButton>
										<telerik:RadToolBarButton id="Button3" runat="server" ButtonType="SkinnedButton" CssClass="c_Button3 Button3" CommandArgument="Button3"
											CommandName="Button3" RenderMode="Lightweight" TabIndex="7" ToolTip="Cancela modificações no registro atual">
										</telerik:RadToolBarButton>
										<telerik:RadToolBarButton id="Button4" runat="server" ButtonType="SkinnedButton" CssClass="c_Button4 Button4" CommandArgument="Button4"
											CommandName="Button4" RenderMode="Lightweight" TabIndex="8" ToolTip="Excluir registro atual">
										</telerik:RadToolBarButton>
										<telerik:RadToolBarButton id="Button10" runat="server" ButtonType="SkinnedButton" CssClass="c_Button10 Button10" CommandArgument="Button10"
											CommandName="Button10" RenderMode="Lightweight" TabIndex="9" ToolTip="Inicia edição no registro atual">
										</telerik:RadToolBarButton>
									</Items>
								</telerik:RadToolBar>
							</div>
							<div id="LayoutCol24" class="col  col-12col-sm-6 c_LayoutCol24">
								<telerik:RadButton id="Button13" runat="server" ButtonType="SkinnedButton" CssClass="c_Button13 button-primary" CommandName="Button13"
									OnClick="___Button13_OnClick" RenderMode="Lightweight" TabIndex="11" Text="<%$ Resources: Button13 %>">
								</telerik:RadButton>
							</div>
						</div>
