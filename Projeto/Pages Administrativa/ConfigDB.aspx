...
<head runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Bootstrap_RadCheckBox_checkbox_toggle_secondary.css" OrderIndex="0"/>
	...
	<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/bootstrap5.min.css??sv=4.0_20250523023113") %>" type="text/css" media="screen" title="no title"/>
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/all.min.css??sv=4.0_20250523023113") %>" type="text/css" media="screen" title="no title"/>  
	</telerik:RadCodeBlock>
</head>
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/bootstrap5.bundle.min.js??sv=4.0_20250523023113") %>" ></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/jquery.js??sv=4.0_20250523023113") %>" ></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Functions.js??sv=4.0_20250523023113") %>"></script>
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Common.js??sv=4.0_20250523023113") %>"></script>


		<script type="text/javascript" src="<%= ResolveUrl("~/JS/RadComboBoxHelper.js??sv=4.0_20250523023113") %>"></script>


	<script type="text/javascript" src="<%= ResolveUrl("~/JS/ConfigDB_USER.js??sv=4.0_20250523023113") %>"></script>
	</telerik:RadCodeBlock>
									...
									<div id="LayoutRow3" class="row c_LayoutRow3">
										<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
											...
											<telerik:RadTextBox id="txtServer" runat="server" AutoPostBack="False" CssClass="c_txtServer textbox-default"
												...
												RenderMode="Lightweight" TabIndex="1" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_txtServer_wrapper" />
										</div>
										<div id="LayoutCol3" class="col col-12 c_LayoutCol3">
											...
											<telerik:RadTextBox id="txtDataBase" runat="server" AutoPostBack="False" CssClass="c_txtDataBase textbox-default"
												EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0" ReadOnly="False"
												RenderMode="Lightweight" TabIndex="2" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_txtDataBase_wrapper" />
										</div>
										...
										<div id="LayoutCol5" class="col col-12 c_LayoutCol5">
											...
											<telerik:RadTextBox id="txtUser" runat="server" AutoPostBack="False" CssClass="c_txtUser textbox-default"
												EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0" ReadOnly="False"
												RenderMode="Lightweight" TabIndex="4" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_txtUser_wrapper" />
										</div>
										<div id="LayoutCol6" class="col col-12 c_LayoutCol6">
											...
											<telerik:RadTextBox id="txtPassword" runat="server" AutoPostBack="False" CssClass="c_txtPassword textbox-default"
												EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0" ReadOnly="False"
												RenderMode="Lightweight" TabIndex="5" TextMode="Password" UseTelerikMask="False" WrapperCssClass="c_txtPassword_wrapper" />
										</div>
										...
										<div id="LayoutCol8" class="col col-12 c_LayoutCol8">
											...
											<telerik:RadTextBox id="txtProvider" runat="server" AutoPostBack="False" CssClass="c_txtProvider textbox-default"
												EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0" ReadOnly="False"
												RenderMode="Lightweight" TabIndex="7" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_txtProvider_wrapper" />
										</div>
