...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class sucessoPageProvider : GeneralProvider
	{

		public sucessoPageProvider(IGeneralDataProvider Provider)
		{
			MainProvider = Provider;
			MainProvider.DataProvider = new DbCupcake_TB_VENDADataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "PK_TB_VENDA", "sucesso");
