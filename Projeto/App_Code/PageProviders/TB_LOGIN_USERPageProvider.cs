...
namespace PROJETO.DataProviders
{
	...
	public class TB_LOGIN_USERPageProvider : GeneralProvider
	{
		...
		public TB_LOGIN_USERPageProvider(IGeneralDataProvider Provider)
		{
			...
			MainProvider.DataProvider = new DbCupcake_TB_LOGIN_USERDataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "LOGIN_USER_PK", "TB_LOGIN_USER");
