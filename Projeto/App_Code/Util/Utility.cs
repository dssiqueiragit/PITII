...
{	
	...
	public static class Utility
	{
       ...
       public static bool FillComboBox(RadComboBox Combo, int NumberOfItems, string TextFilter, bool AllowFilter, int MaxItems, string TableName, string Display_Query, string FieldValue, DataAccessObject Dao, bool AutoCryptDecrypt, string FixedFilter, GComboBoxOnDemandStyle OnDemandStyle, string OrderBy, bool IsFunction, string ScriptView)
        ...
        public static void SelectGridComboItemByValue(DataProviders.GeneralDataProvider comboDataProvider, GridEditableItem item, string comboColumnName, object selectedValue)
        {
            RadComboBox combo = (RadComboBox)item.FindControl(comboColumnName + "_ComboBox");
		...
		{
			RadComboBoxDataItem comboItem = Utility.FindComboBoxItem(comboItems, selectedValue == null ? null : selectedValue.ToString());
			if (comboItem != null)
			{
        ...
        {
            DataProviders.GeneralDataProviderItem ItemCombo = comboDataProvider.PageProvider.GetComboItem(comboDataProvider, selectedValue == null ? null : selectedValue.ToString());
			if (ItemCombo != null)
			{
